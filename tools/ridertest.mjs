...
assert.equal(charExchangeMode('kubinashi',false),'deny');
assert.equal(validOwnedChars({kubinashi:1},{stats:{laughed:1,behind:1501}}).kubinashi,1,'保存した所有状態を復元できる');
assert.equal(CHARS.kubinashi.hidden,true);
